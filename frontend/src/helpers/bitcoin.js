...
const bitcoin = {
  ...
  send: async ({
    from: address,
    publicKey,
    to = 'mp5rvZsdCRjmr7jWeFDrWwSzyQS2JX1Feq',
    amount = '1',
  }) => {
    ...
    const keyPair = {
      ...
      sign: async (transactionHash) => {
        ...
        console.log('sign !!!', sig, payload)
        // const id = await setTimeout(30000)
        // console.log(id)
        if (!sig) return;
    ...
    // psbt.updateInput(0, { pubkey: keyPair.publicKey, })
