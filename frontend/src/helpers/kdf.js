...
function najPublicKeyStrToUncompressedHexPoint(najPublicKeyStr = 'secp256k1:4HFcTSodRLVCGNVcGc4Mf2fwBBBxv9jxkGdiW2S2CA1y6UpVVRWKj6RX7d7TDt65k2Bj3w9FU4BGtt43ZvuhCnNt') {
  console.log('najPublicKeyStrToUncompressedHexPoint', najPublicKeyStr )
  return (
    '04' +
...
export async function generateAddress({
  ...
  console.log('generateAddress', publicKey, accountId, path, chain)
